...
2. Queue flow matches SPEC.md §3.2 (correct queue reads/writes)
3. Pydantic v2 models used for all data structures
4. async/await used for all I/O operations
5. No LLM calls in Phase 1 — rule-based extraction only
...
## Process
1. Read the architecture docs (docs/architecture.md, SPEC.md)
